        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start w-full">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6 w-full lg:pl-12">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 pl-6">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-zinc-800 uppercase tracking-wider">Module Description</label>
                <textarea
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-semibold text-zinc-800 uppercase tracking-wider">Start / Release Date</label>
                <input
                  type="date"
                  value={date}
                ...
                <div className="flex flex-col gap-2 pt-1">
                  ...
                  <div className="flex flex-col gap-1.5">
                    {subject.schedules.map((sch, i) => (
                      <div
                        key={i}
                        className="flex justify-between items-center text-[11px] font-semibold text-zinc-800 bg-zinc-50 px-3 py-2 border border-[#E5E1D8]/70 rounded-xl"
                      >
            ...
            <div className="bg-white border border-[#E5E1D8]/70 rounded-3xl shadow-[0_12px_32px_-12px_rgba(0,0,0,0.02)] p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4 text-[12px] text-zinc-600 font-medium">
                <div className="flex gap-2.5 items-start bg-[#facc15]/5 p-3 rounded-2xl border border-[#f97316]/10 text-zinc-800">
                  ...
                  <div>
                    <span className="font-semibold text-[12px] block text-[#d97706] mb-0.5">Syllabus Structure</span>
                ...
                <div className="flex gap-2.5 items-start bg-zinc-50 p-3 rounded-2xl border border-[#E5E1D8]/70">
                  ...
                  <div>
                    <span className="font-semibold block text-zinc-800">Release Dates</span>
